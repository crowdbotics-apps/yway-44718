"""
Django settings for yway_44718 project.
...
WSGI_APPLICATION = 'yway_44718.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "yway_44718 API",
    "DESCRIPTION": "API documentation for yway_44718 App",
    "VERSION": "v1",
}
